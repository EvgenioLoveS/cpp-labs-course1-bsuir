...
/*void List::Update(QString numFlight, QString newTypePlane, QString newDestination, QTime newDepartureTime)
{
    AirInf *temp = head;
    while (temp != nullptr)
    {
        if (temp->numFlight == numFlight)
        {
            temp->typePlane = newTypePlane;
...
/*void List::editFlight(const QString &destination)
{
    AirInf *temp = head;
    while (temp != nullptr)
    {
